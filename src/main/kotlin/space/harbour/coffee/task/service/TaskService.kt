...
import space.harbour.coffee.task.exception.TaskOperationException
import space.harbour.coffee.task.persistence.TaskEntity
import space.harbour.coffee.task.repository.TaskRepository
import space.harbour.coffee.task.service.mapper.toDomain
...
class TaskService(
    ...
    @Transactional
    fun addTask(description: String, status: TaskStatus = TaskStatus.NEW): Task {
